...
import com.example.simplenavigationfragments.databinding.FragmentConfiguracionBinding
import com.google.android.material.appbar.MaterialToolbar
import com.google.android.material.bottomnavigation.BottomNavigationView


class ConfiguracionFragment : Fragment(), MainActivity.FragmentInteractionListener, MenuProvider {
        ...
        bottomBar.setOnItemSelectedListener { menuItem ->
            when (menuItem.itemId){
                R.id.bottom_nav_principal ->{
                    findNavController().navigate(R.id.action_configuracionFragment_to_principalFragment)
                    true
                }
                R.id.bottom_nav_cuenta -> {
                    findNavController().navigate(R.id.action_configuracionFragment_to_cuentaFragment)
                    true
                }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.configTextView.text = getString(
            R.string.fragment_custom_messages, user, getString(R.string.config_title_toolbar)
        )
    }
    ...
    override fun onMenuItemSelected(menuItem: MenuItem): Boolean {
        return when (menuItem.itemId) {
            R.id.icon_item_close -> {
                findNavController().navigate(R.id.action_configuracionFragment_to_inicioFragment)
                true
            }
            else -> false
        }
